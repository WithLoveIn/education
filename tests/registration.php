					...
					<div class="wrapper p-3">					
						<form method="post"	id="form_reg" action="check_registrate.php">
							<div class="d-flex row align-items-center m-0" id="block-form-registration">
								<label for="" class="col-12 col-sm-5 d-flex justify-content-sm-end mb-0 pl-1 pb-sm-2">Email</label>
								...
								<label for="" class="col-12 col-sm-5 d-flex justify-content-sm-end mb-0 pl-1 pb-sm-2">Фамилия</label>
								<input type="text" name="reg_sername" id="reg_sername" class="col-12 col-sm-6 mx-1 col-md-5 col-lg-4">
		 						<label for="" class="col-12 col-sm-5 d-flex justify-content-sm-end mb-0 pl-1 pb-sm-2">Имя</label>
								<input type="text" name="reg_name" id="reg_name" class="col-12 col-sm-6 mx-1 col-md-5 col-lg-4">
								<label for="" class="col-12 col-sm-5 d-flex justify-content-sm-end mb-0 pl-1 pb-sm-2">Адрес</label>
								...
								<label for="" class="col-12 col-sm-5 d-flex justify-content-sm-end mb-0 pl-1 pb-sm-2">Класс</label>
								<input type="text" name="reg_class" id="reg_class" class="col-12 col-sm-6 mx-1 col-md-5 col-lg-4">
								<label for="" class="col-12 col-sm-5 d-flex justify-content-sm-end mb-0 pl-1 pb-sm-2">Ссылка на фото</label>
